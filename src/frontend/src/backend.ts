...
export class Backend implements backendInterface {
    ...
    async addDoctor(arg0: Doctor): Promise<DoctorId> {
        if (this.processError) {
            try {
    ...
    async addHealthPackage(arg0: HealthPackage): Promise<PackageId> {
        if (this.processError) {
            try {
    ...
    async addService(arg0: Service): Promise<ServiceId> {
        if (this.processError) {
            try {
    ...
    async bookAppointment(arg0: Appointment): Promise<AppointmentId> {
        if (this.processError) {
            try {
    ...
    async deleteHealthPackage(arg0: PackageId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateDoctor(arg0: DoctorId, arg1: Doctor): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateHealthPackage(arg0: PackageId, arg1: HealthPackage): Promise<void> {
        if (this.processError) {
            try {
